...
const project_title = 'Tutaz';
const domain_name = 'https://tut.az/';

const SEO = ({ title, description = 'The best testing environment made real!', thumbnail = '/img/thumbnail.png', url = 'https://tut.az' }) => {
  return (
    <Head>
      <title>Kodaze{title && ` | ${title}`}</title>
